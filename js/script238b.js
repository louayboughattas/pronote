...
/*global jRespond */
var jPM = {};
var PLUGINS_PATH = location.protocol + '//' + sAppstrapHostData + '/js/plugins/';
...
jQuery(document).ready(function() {
    ...
    if (jQuery('[data-toggle=jpanel-menu]').length > 0) {
        var initjPMenu = function() {
            ...
            jPM = jQuery.jPanelMenu({
                ...
                excludedPanelContent: '.jpanel-menu-exclude, style, script, .modal',
                openPosition: '280px',
                afterOpen: function() {
    ...
    if (jQuery('[data-toggle=slider-rev]').length > 0) {
        ...
        jQuery().themeLoadPlugin(
            ["slider-revolution/rs-plugin/js/jquery.themepunch.tools.min.js?v=" + SLIDER_REV_VERSION, "slider-revolution/rs-plugin/js/jquery.themepunch.revolution.min.js?v=" + SLIDER_REV_VERSION], ["slider-revolution/rs-plugin/css/settings.css?v=" + SLIDER_REV_VERSION],
            initSliderRev
        );
    }
